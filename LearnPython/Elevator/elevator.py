...
def elevator_move(passenger , elevator):
    while elevator.current_floor != passenger.current_floor:
        ...
        log.write("лифт на {} этаже ; пассажир на {} этаже" .format(elevator.current_floor , passenger.current_floor))
        time.sleep(0.5)
    ...
    log.write("Лифт {} подан! пассажир на {} этаже, лифт на этаже {}" .format(elevator.elevator_number , passenger.current_floor , elevator.current_floor))
    print("---------------------------------------")
    time.sleep(2)
